...
if __name__ == '__main__':
    ...
    parser.add_argument("--z1", help="First redshift bin center. Default: %(default)s", type=float, default=1.9)
    parser.add_argument("--z2", help="First redshift bin center. Default: %(default)s", type=float, default=4.4)
    parser.add_argument("--nz", help="Number of redshift bins. Default: %(default)s", type=int, default=10000)
    parser.add_argument("--fg08", help="Generate FG 2008 mean flux instead", action="store_true")
    ...
    mean_flux_table.write(fname_mean_flux, format='ascii.fixed_width', \
        formats={'z':'%.10e', 'meanF':'%.10e'}, overwrite=True)
